...
static NSString *SymphoxAPI__token = @"api/portal/app/treemall/token";
...
static NSString *SymphoxAPI__register = @"api/portal/app/treemall/member/register";
static NSString *SymphoxAPI__login = @"api/portal/app/treemall/member/identify";
static NSString *SymphoxAPI__terms = @"api/onlineService.do";
static NSString *SymphoxAPI__forgetPassword = @"api/portal/app/treemall/member/password/forget";
static NSString *SymphoxAPI__mobileVerification = @"api/portal/app/treemall/member/verify/mobile";
...
static NSString *SymphoxAPI__Subcategories = @"api/portal/app/treemall/mall/hall";
...
static NSString *SymphoxAPI__hotKeywords = @"api/portal/app/treemall/mall/keyword";
static NSString *SymphoxAPI__memberInformation = @"api/portal/app/treemall/member/info";
static NSString *SymphoxAPI__memberPoint = @"api/portal/app/treemall/member/point";
static NSString *SymphoxAPI__memberCoupon = @"api/portal/app/treemall/member/ecoupon";
static NSString *SymphoxAPI__productDetail = @"api/portal/app/treemall/mall/product";
static NSString *SymphoxAPI__memberOrder = @"api/portal/app/treemall/member/order";
static NSString *SymphoxAPI__emailAuth = @"api/portal/app/treemall/member/verify/email";
static NSString *SymphoxAPI__changePassword = @"api/portal/app/treemall/member/password/update";
static NSString *SymphoxAPI__newsletter = @"api/portal/app/treemall/member/edm";
static NSString *SymphoxAPI__subscribeNewsletter = @"api/portal/app/treemall/member/edm/update";
static NSString *SymphoxAPI__orderNumberOfStatus = @"api/portal/app/treemall/member/order/status";
...
static NSString *SymphoxAPI__getContactInfo = @"api/portal/app/treemall/member/contact";
...
static NSString *SymphoxAPI__getDeliveryProgress = @"api/portal/app/treemall/member/order/delivery";
